...
void file_thread_function (string filename, BoundedBuffer* requestBuf, FIFORequestChannel* chan, int bcap) {
...
void worker_thread_function(BoundedBuffer* requestBuf, FIFORequestChannel* chan, BoundedBuffer* responseBuf, int bcap){
    /*
...
int main(int argc, char *argv[])
{
    ...
    while ((opt = getopt(argc, argv, "n:p:h:w:b:m:f:")) != -1) {
		switch (opt) {
            case 'n':
                n = atoi (optarg);
                break;
